...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href="Reservasi.php"><em class="fa fa-dashboard">&nbsp;</em>dashboaard</a></li>
	...
	<h2 style="font-family: tahoma;font-size: 15;">MENAMPILKAN DATA RESERVASI</h2>
	<br/>
	<br/>
	<br/>
