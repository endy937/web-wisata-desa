...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="data_wisata.php"><em class="fa fa-calendar">&nbsp;</em>Data Wisata</a></li>
			<li><a href="data_pemesanan.php"><em class="fa fa-bar-chart">&nbsp;</em>Data Pemesan</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Data Wisata Desa Cikarangsuka</h1>
			</div>
		</div>
	<table width="100%" height="100" class="table">
		...
		//memanggil ada 3 yaitu include,require,require_once
			include 'koneksi.php';
			$no = 1;
			$query = mysqli_query( $koneksi,'select * from data_wisata');// kode menampilkan data *=pilih semua
			...
			<tr >
				...
				<td><?php echo $tampil['nama_wista'] ?></td>
